...
- 学习目标写成可观察的演奏、听辨、记录或产出结果，不用“理解”“掌握”代替证据。
...
- 每篇用阶段选择表说明“本周期只解决什么”、核心卡和进入下一阶段的证据，再提供可复用的训练日 1 至训练日 7 角色循环；休息后按下一个训练日顺延。
- 每项练习写清目的、准备、步骤、时长或次数、量化要求、自检和难度调整。
- 连续 3 遍达到节奏、放松、音准、干净度和专项要求后，每次只增加速度、音数、方向、技巧或效果中的一个变量。
- 开放式听力、推导、创作或编配任务第一次出现时，先提供原创示范、可展开答案、推理过程和常见错误。
- 完成标准分为“已经获得的证据”“下周期继续维护”“可选巩固”，不得把篇内全部内容写成进阶硬门槛。
